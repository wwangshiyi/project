...
var _common = _interopRequireDefault(__webpack_require__(/*! ../../common .js */ 52));
//
//
//
//
...
var _default = {
  data: function data() {
    return {
      ...
      total: 4,
      matter: [{
        image: __webpack_require__(/*! ../../static/previewFix.jpg */ 53),
        text: "模拟假数据",
        labelOne: "好看图片",
        labelTwo: "商品名称",
        labelThree: "商品标签",
        ...
        image: __webpack_require__(/*! ../../static/previewFix (1).jpg */ 54),
        text: "假数据",
        labelOne: "好看图片",
        labelTwo: "商品名称",
        labelThree: "商品标签",
